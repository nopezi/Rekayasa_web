...
<div class="container">
	<div class="row">
  <h2><center>DATA LAB PARASITOLOGI</center></h2>
		<div class="jumbotron">

    <center><a href="<?php echo base_url('login/tambah_parasitologi') ?>" class="btn btn-primary">Tambah Data</a></center>
    <br>
  ...
  <?php $no = 1; foreach($datalab_parasit as $u) {?>
  ...
  <tbody>
      ...
      <td><?php echo anchor('login/edit/'.$u->id,'<div class="btn btn-primary">Edit</div>'); ?></td>
      <td><?php echo anchor('login/hapus/'.$u->id,'<div class="btn btn-danger">Hapus</div>') ?></td>
